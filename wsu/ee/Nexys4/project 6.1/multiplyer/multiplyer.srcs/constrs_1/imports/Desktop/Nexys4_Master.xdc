...
set_property PACKAGE_PIN T8 [get_ports {R[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {R[0]}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {R[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {R[1]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {R[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {R[2]}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
set_property PACKAGE_PIN T6 [get_ports {R[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {R[3]}]
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
set_property PACKAGE_PIN T5 [get_ports {R[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {R[4]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {R[5]}]					
...
set_property PACKAGE_PIN U6 [get_ports {R[7]}]					
