...
XELAB_1="/home/mikel/Desktop/Project 6/Project 6.1/Multiplyer/Multiplyer.sim/sim_1/behav/test_Mult.prj"

ExecStep xelab -m32 --debug typical --relax -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot test_Mult_behav --prj "$XELAB_1"   xil_defaultlib.test_Mult   xil_defaultlib.glbl
