...
set_property PACKAGE_PIN R3 [get_ports {OpCode[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OpCode[0]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {OpCode[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OpCode[1]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {OpCode[2]}]					
...
set_property PACKAGE_PIN T4 [get_ports {led[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led[4]}]
