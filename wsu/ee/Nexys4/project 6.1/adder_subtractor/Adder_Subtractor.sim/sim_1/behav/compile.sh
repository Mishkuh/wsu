...
XELAB_1="/home/mikel/Desktop/Project 6/Project 6.1/Adder_Subtractor/Adder_Subtractor.sim/sim_1/behav/test.prj"

ExecStep xelab -m32 --debug typical --relax -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot test_behav --prj "$XELAB_1"   xil_defaultlib.test   xil_defaultlib.glbl
