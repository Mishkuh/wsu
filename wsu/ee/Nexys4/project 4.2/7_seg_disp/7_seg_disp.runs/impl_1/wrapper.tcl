...
set rc [catch {
  ...
  add_files -quiet /home/mikel/Desktop/7_seg_disp/7_seg_disp.runs/synth_1/wrapper.dcp
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache {/home/mikel/Desktop/7_seg_disp/7_seg_disp.cache} }
  opt_design 
...
set rc [catch {
  ...
  if { [file exists /home/mikel/Desktop/7_seg_disp/7_seg_disp.runs/synth_1/wrapper.hwdef] } {
    catch { write_sysdef -hwdef /home/mikel/Desktop/7_seg_disp/7_seg_disp.runs/synth_1/wrapper.hwdef -bitfile wrapper.bit -meminfo wrapper_bd.bmm -file wrapper.sysdef }
  }
