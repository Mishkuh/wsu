...
XELAB_1="/home/mikel/Desktop/Project 6/Project 6.3/VGA_Display_controller/VGA_Display_controller.sim/sim_1/behav/test_controller.prj"

ExecStep xelab -m32 --debug typical --relax -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot test_controller_behav --prj "$XELAB_1"   xil_defaultlib.test_controller   xil_defaultlib.glbl
