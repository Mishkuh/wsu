...
XELAB_1="/home/mikel/Desktop/Project 6.2/Count_clk_div/Count_clk_div.sim/sim_1/behav/test_sseg.prj"

ExecStep xelab -m32 --debug typical --relax -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot test_sseg_behav --prj "$XELAB_1"   xil_defaultlib.test_sseg   xil_defaultlib.glbl
