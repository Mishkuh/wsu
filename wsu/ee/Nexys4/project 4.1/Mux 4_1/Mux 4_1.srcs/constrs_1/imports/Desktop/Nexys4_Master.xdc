...
set_property PACKAGE_PIN T16 [get_ports {Sel[0]}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {Sel[0]}]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports {Sel[1]}]						
